  ...
  final List<Map<String, dynamic>> _mockMenuData = [
    {
      ...
      'items': [
        ...
        const Product(
          ...
          description:
              'Pomodoro, Fiordilatte, Nduja di Spilinga, Salame Piccante, Olive Nere.',
          basePrice: 9.50,
          image: 'assets/images/homepage/pizza_homepage.jpg',
          rating: 4.8,
          isHot: true,
    ...
    },
    {
      ...
      'items': [
        const Product(
          ...
          description:
              'Pasta all\'uovo, ragù di carne, ricotta, provola e parmigiano.',
          basePrice: 10.00,
          image: 'assets/images/homepage/gastronomy.jpg',
          rating: 4.9,
          allergens: ['Glutine', 'Lattosio', 'Uova'],
          baseIngredients: [
            Ingredient(name: 'Ragù'),
            Ingredient(name: 'Ricotta'),
          ],
          extraOptions: [],
        ),
        const Product(
          ...
          description:
              'Melanzane fritte, pomodoro, fiordilatte, parmigiano e basilico.',
          basePrice: 8.00,
          image: 'assets/images/homepage/gastronomy.jpg',
          rating: 4.8,
          isVeg: true,
        ...
        const Product(
          ...
          description:
              'Polpette di manzo cucinate lentamente nel nostro sugo San Marzano.',
          basePrice: 9.00,
          image: 'assets/images/homepage/gastronomy.jpg',
          rating: 4.7,
          allergens: ['Glutine', 'Uova'],
          baseIngredients: [
            Ingredient(name: 'Carne di Manzo'),
            Ingredient(name: 'Pomodoro'),
          ],
          extraOptions: [],
        ),
    ...
    },
    {
      ...
      'items': [
        const Product(
          ...
          description:
              'Riso allo zafferano con cuore di ragù di carne e piselli.',
          basePrice: 3.50,
          image: 'assets/images/homepage/rosticceria.jpg',
          rating: 4.9,
          isBestSeller: true,
        ...
        const Product(
          ...
          description:
              'Patate lesse, prezzemolo, pecorino e cuore di provola filante.',
          basePrice: 2.50,
          image: 'assets/images/homepage/rosticceria.jpg',
          rating: 4.8,
          isVeg: true,
        ...
        const Product(
          ...
          description:
              'Bucatini con besciamella, carne macinata, piselli e pepe.',
          basePrice: 3.50,
          image: 'assets/images/homepage/rosticceria.jpg',
          rating: 4.7,
          allergens: ['Glutine', 'Lattosio'],
          baseIngredients: [
            Ingredient(name: 'Bucatini'),
            Ingredient(name: 'Besciamella'),
          ],
          extraOptions: [],
        ),
      ],
    },
    {
      ...
      'items': [
        const Product(
          ...
          description:
              'Una selezione delle nostre migliori pizze in formato ridotto per assaggiare tutto.',
          basePrice: 25.00,
          image: 'assets/images/homepage/delivery.jpg',
          rating: 4.7,
          allergens: ['Glutine', 'Lattosio'],
          baseIngredients: [
            Ingredient(name: '4 Mini Pizze'),
            Ingredient(name: 'Fritti misti'),
          ],
        ...
        const Product(
          name: 'Family Box',
          description:
              '2 Pizze Classiche + 2 Bibite + Porzione di Patatine Grandi.',
          basePrice: 22.00,
          image: 'assets/images/homepage/delivery.jpg',
          rating: 4.6,
          allergens: ['Glutine', 'Lattosio'],
          baseIngredients: [
            Ingredient(name: '2 Pizze'),
            Ingredient(name: 'Patatine'),
          ],
        ...
        const Product(
          ...
          allergens: ['Glutine', 'Lattosio'],
          baseIngredients: [
            Ingredient(name: '1 Pizza'),
            Ingredient(name: '2 Arancini'),
          ],
